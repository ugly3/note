...
uint8_t Two_Code_Init_Data_Store[3][200] = {0};   //存储全部二维码初始数据
...
uint8_t TFT_License_Data_Store[7] = {0}; //车牌数据存储
uint8_t TFT_Traffic_Data_Store[6] = {0}; //交通标志数据存储
uint8_t TFT_GraphCount_Data_Store[7] = {0}; //图形数量数据存储
uint8_t TFT_GraphColour_Data_Store[7] = {0}; //图形颜色数据存储
uint8_t TFT_GraphAndColour_Data_Store[6] = {0}; //图形(数量+颜色)数据存储
uint8_t TFT_Mask_Data_Store[6] = {0}; //口罩行人数量
uint8_t TFT_Words_Data_Store[6] = {0}; //文字存储数据  0x53,0x6B,0x69,0x6C,0x6C,0x73
uint8_t TFT_Car_Type_Data_Store= 0; //车型存储数据
...
uint8_t Identify_TFT_Store[8] = {0x55,0xFF,0x00,0x00,0x00,0x00,0x00,0xBB}; //万能命令
/* 
【终端发送给主车的格式】
