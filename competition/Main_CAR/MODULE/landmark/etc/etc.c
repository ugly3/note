...
void xETC_Pass(void)
{
	...
	{	
		...
		{
			Motor_Data.xCAR_Back(20,350);//往后一点
		}
		...
		{
            Motor_Data.xCAR_Go(20,350);//往前一点
		}
#endif		
	}
...
void xETC_Pass_RFID(uint8_t card1,uint8_t card2,uint8_t card3)
{
	...
	{	
        ...
        if(Communication_Data.ETC_Open_Flag == 1)   //ETC打开
        {
            ...
            ETC_Data.ETC_Car_Start = 0;
            Motor_Data.xCAR_Track_Go();		
//            RFID_Data.xRFID_Track_Read_1(25,card1);//寻卡
            RFID_Data.xRFID_Track_Read_2(30,Judge_Card_Block,Real_Card1_Block,Real_Card2_Block); //寻卡
            delay_ms(200);
            break;
        }
        else   
        {
                Motor_Data.xCAR_Back(15,400);//往后一点
        }
        delay_ms(200);
        if(Communication_Data.ETC_Open_Flag == 1)   //ETC打开
				{
...
//            RFID_Data.xRFID_Track_Read_1(25,card1);//寻卡
        ...
        {
            Motor_Data.xCAR_Go(15,400);//往前一点  
        }
...
//			RFID_Data.xRFID_Track_Read_1(25,card1);//寻卡			
		...
		{
			Motor_Data.xCAR_Back(20,400);//往后一点
		}
