...
extern uint32_t temp_MP;
extern volatile uint32_t dis_MP;
extern uint32_t temp_Nav;
extern volatile uint8_t Stop_Flag;
extern void wheel_Track_check(void);
extern volatile uint16_t track_time_ms;
